...
if (!function_exists('addons_url')) {
     ...
     * @return bool|string
     */
    function addons_url(string $url = '', array $param = [], $suffix = true, $domain = false)
    {
        $request = app('request');
        if (empty($url)) {
            // 生成 url 模板变量
